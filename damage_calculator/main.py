...
if __name__ == '__main__':
    ...
    kara = Kara(strength=4, proficiency_bonus=3, equipment_bonus=0)
    ...
    for ac in range(min_ac, max_ac + 1):
        ...
        kara_average[ac] = kara.calculate_ten_turn_average(ac)
    ...
    ax.plot(kara_average, label='Kara')
